// Franchise Enquiry Form with Full Validation (Updated)
...
//     let errorEl = input.type === "checkbox"
...
//       errorEl.classList.add("hidden");
//     }
//     input.classList.remove("border-red-500", "ring-2", "ring-red-300", "outline", "outline-1", "outline-red-500");
//   }
...
//             otpError.textContent = "Failed to send OTP. Please try again later.";
